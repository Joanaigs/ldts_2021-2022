...
public final class Constants {
    ...
    //MENU SCREEN
    public static final int MENU_SCREEN_WIDTH = 59;
    public static final int MENU_SCREEN_HEIGHT = 29;
    ...
    public static final String SMALL_COIN = "#F1DEDE";
    public static final String WHITE = "#FFFFFF";
    public static final String DARK_BLUE =  "#2121DE";   // color of ghost's eyes and body on Frightened
    public static final String WALLS = "#2e4981";  // color of walls
